    ...
    <div  className={classes.back}>
      ...
      <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea type="text" class="form-text" name="description"  required defaultValue={user.adhaar} ref={register} placeholder="Enter Job Description" ></textarea>
          </div>
        </div>
